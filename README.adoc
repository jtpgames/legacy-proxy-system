...
* **High broker load:** Under sustained high throughput / heavy broker load, HiveMQ (CE and Edge) may become *sticky* and route almost everything to a single subscriber for an extended period (effectively disabling load balancing).
